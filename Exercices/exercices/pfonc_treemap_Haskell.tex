...
\begin{itemize}
\item \haskellinline{tmLookup}: retourne la valeur associée à une clé passée
  en paramètre.
\item \haskellinline{tmInsert}: ajoute une entrée (donnée sous la forme
  d'une clé et de sa valeur) dans la table.
\item \haskellinline{tmRemove}: enleve une entrée (dont la clé est passée
  en paramètre).
\end{itemize}

Ces fonctions ne doivent jamais planter ou utiliser la primitive \codeinline{error}.
